      ...
      <footer className="text-center w-full lg:text-left text-white relative">
        <div className="flex justify-center items-center md:justify-center  p-6 border-b border-gray-300">
          ...
          <div className="flex justify-center">
            <a href="https://www.facebook.com/share/12ikhNuYxmHvSoNk/?mibextid=qtnXGe" className="mr-6  text-white md:dark:text-white">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
        ...
        <div className="mx-6 py-5 lg:py-10 text-center md:text-left">
          <div className="grid grid-1 justify-items-stretch md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="">
              ...
              "Journey Together, Succeed Together"
              </p>
            </div>
            ...
            <div className="justify-self-center">
              ...
              <p className="flex items-center justify-center md:justify-start mb-2 lg:mb-4 md:dark:text-white">
                ...
                >
                  ...
                  Ethiopia,Oromia,Mojo infront of Courage Hotel or next to Hundaol Hotel.
              </p>
              <p className="flex items-center justify-center md:justify-start mb-2 lg:mb-4 md:dark:text-white">
                <svg
                  aria-hidden="true"
              ...
              <p className="flex items-center justify-center md:justify-start mb-2 lg:mb-4 md:dark:text-white">
                ...
                +251222362626, +251965730540,    +251964364110
              </p>
        ...
        <div className="text-center p-6 bg-white dark:bg-gray-900">
          ...
          >
            Mojo Business Group. All Rights Reserved. <br/><i> Designed and Developed by __________</i>
          </a>
        </div>
      </footer>
    </div>
